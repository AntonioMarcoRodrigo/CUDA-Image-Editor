...
void operations(const uchar4 * const h_inputImageRGBA, uchar4 * const d_inputImageRGBA,
...
int main(int argc, char **argv) {
  ...
  GpuTimer timer;
  timer.Start();
  //call the operations code
  operations(h_inputImageRGBA, d_inputImageRGBA, d_outputImageRGBA, numRows(), numCols(),
